...
def certificate_to_award(displayable_certificate):
    print("certificate_formmater > certificate_to_award has been called")
...
def get_formatted_award_and_verification_info(cert_store, certificate_uid):
    ...
    :return:
    """
    print("certificate_formmater > get_formatted_award_and_verification_info has been called")
...
def get_displayable_blockchain_type(chain):
    ...
    print("certificate_formmater > get_displayable_blockchain_type has been called")
